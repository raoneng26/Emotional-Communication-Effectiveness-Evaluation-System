...
class GetTwitterInfo:
    ...
    def get_comment(self):
        ...
        if comment_count != 0:
            ...
            for i in range(1,int(comment_count)+1):
                ...
                try:           
                    user_name = driver.find_element(By.XPATH, 
                                                    f"/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/section/div/div/div[{i*2+2}]/div/div/article/div/div/div[2]/div[2]/div[1]/div/div[1]/div/div/div[1]/div/a/div/div[1]/span/span").text
                    print(user_name)
                    comment =driver.find_element(By.XPATH,
                                                f'/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/section/div/div/div[{i*2+2}]/div/div/article/div/div/div[2]/div[2]/div[2]/div/span').text                       
                    print(comment)     
                    post_time= driver.find_element(By.XPATH,
                                                f'/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/section/div/div/div[{i*2+2}]/div/div/article/div/div/div[2]/div[2]/div[1]/div/div[1]/div/div/div[2]/div/div[3]/a/time').text                       
                    # c_post_time = gmt_trans(post_time)
                    c_post_time=convert_date(post_time)
                    print(c_post_time)    
                    try:
                        like_count=driver.find_element(By.XPATH,
                                                f'/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/section/div/div/div[{i*2+2}]/div/div/article/div/div/div[2]/div[2]/div[3]/div/div/div[3]/div/div/div[2]/span/span/span').text                       
                    except:
                        like_count=0
                    print(like_count)
                    # 定位查看评论者主页，并点击
                    button1 = driver.find_element(By.XPATH, 
                                                    f"/html/body/div[1]/div/div/div[2]/main/div/div/div/div[1]/div/section/div/div/div[{i*2+2}]/div/div/article/div/div/div[2]/div[2]/div[1]/div/div[1]/div/div/div[1]/div/a/div/div[1]/span/span")
                    button1.click()  
                    time.sleep(3)     
                    # 粉丝数
                    try:
    ...
    def twitter_craw(self):     
        w = GetTwitterInfo.get_comment(self)
        print('爬虫完成')
