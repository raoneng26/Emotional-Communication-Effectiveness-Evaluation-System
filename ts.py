                ...
                with open(file5, "a+", errors="ignore", newline='', encoding='utf-8') as fp:
                    ...
                    for i in range(1, 10): #原50
                        try:
                            ...
                            driver.implicitly_wait(10)
                            time.sleep(2)
                            videos = driver.find_elements(By.CSS_SELECTOR,"div.video-list.row > div")
                            if videos:
                                for video in videos:
                                    video_url = video.find_element(By.CSS_SELECTOR,'div.bili-video-card__wrap.__scale-wrap > a').get_attribute(
                                        'href')
                                    publish_time = video.find_element(By.CSS_SELECTOR,"span.bili-video-card__info--date").text
                                    up_name = video.find_element(By.CSS_SELECTOR,"span.bili-video-card__info--author").text
                                    title = video.find_element(By.CSS_SELECTOR,"a > h3").text       
                                    #i_cecream > div > div:nth-child(2) > div.search-content--gray.search-content > div > div > div > div.video.i_wrapper.search-all-list > div > div:nth-child(1) > div > div.bili-video-card__wrap.__scale-wrap > a > div > div.bili-video-card__mask > div > div > span:nth-child(1)                            
                                    view_number = video.find_element(By.CSS_SELECTOR,"div.bili-video-card__mask > div > div > span:nth-child(1)").text
                                    #i_cecream > div > div:nth-child(2) > div.search-content--gray.search-content > div > div > div > div.video.i_wrapper.search-all-list > div > div:nth-child(1) > div > div.bili-video-card__wrap.__scale-wrap > a > div > div.bili-video-card__mask > div > span
                                    length = video.find_element(By.CSS_SELECTOR,"div.bili-video-card__mask > div > span").text
                                    writer.writerow(
